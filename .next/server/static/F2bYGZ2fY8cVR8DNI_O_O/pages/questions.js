...
module.exports = __webpack_require__("KYN/");
...
// CONCATENATED MODULE: ./components/QuestionList.js
...
var GET_QUESTIONS = Object(external_apollo_boost_["gql"])(_templateObject());
function QuestionList(_ref) {
  var client = _ref.client;

  var _useQuery = Object(react_hooks_["useQuery"])(GET_QUESTIONS),
      loading = _useQuery.loading,
      error = _useQuery.error,
      data = _useQuery.data;

  if (data && data.questions) {
    return external_react_default.a.createElement("ul", null, data.questions.map(function (question) {
      return external_react_default.a.createElement("li", {
        key: Math.random()
      }, question.prompt, " (", question.trap.name, ")");
    }));
  } else if (error) {
    return external_react_default.a.createElement("div", null, error.message);
  } else {
    return external_react_default.a.createElement(external_semantic_ui_react_["Dimmer"], {
      active: true
    }, external_react_default.a.createElement(external_semantic_ui_react_["Loader"], null));
  }
}
// EXTERNAL MODULE: ./components/AppLayout.js
var AppLayout = __webpack_require__("1zst");

// CONCATENATED MODULE: ./pages/questions.js




/* harmony default export */ var questions = __webpack_exports__["default"] = (Object(apollo["a" /* default */])(function () {
  return external_react_default.a.createElement(AppLayout["a" /* default */], null, external_react_default.a.createElement(QuestionList, null));
}));
