...
/* harmony import */ var _data_user__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../data/user */ "./data/user.js");
...
const Login = ({
  ...
  const [login, {
    ...
    data,
    error
  }] = Object(_apollo_react_hooks__WEBPACK_IMPORTED_MODULE_2__["useMutation"])(_data_user__WEBPACK_IMPORTED_MODULE_8__["AUTHENTICATE_USER"]);
  const {
    inputs,
    handleChange,
    handleSubmit
...
const GET_USER = apollo_boost__WEBPACK_IMPORTED_MODULE_0__["gql"]`
  query {
    user {
      firstName
    }
...
`;
const AUTHENTICATE_USER = apollo_boost__WEBPACK_IMPORTED_MODULE_0__["gql"]`
...
`;
const SIGNUP_USER = apollo_boost__WEBPACK_IMPORTED_MODULE_0__["gql"]`
...
const authLink = Object(apollo_link_context__WEBPACK_IMPORTED_MODULE_2__["setContext"])((_, {
  ...
  let token = Object(_auth__WEBPACK_IMPORTED_MODULE_4__["getToken"])();
  return {
    headers: {
...
/* harmony default export */ __webpack_exports__["default"] = (Object(next_apollo__WEBPACK_IMPORTED_MODULE_0__["withData"])(() => {
  return {
